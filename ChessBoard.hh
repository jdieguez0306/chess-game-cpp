...
namespace Student
{
    ...
    public:
        ...
        * @param other
        ...
        /**
         * @brief
         * Deconstructor for the ChessBoard
         */
        ~ChessBoard();
         ...
         * @param row
         * The row of piece to be moved.
         * @param column
         * The column of the piece to be moved.
         * @return
         * Returns true if move stays within the bounds of chessboard.
         */
        bool inBounds(int row, int column);

        /**
         * @brief
         * Checks if a position is occupied by another piece
         * @param row
         * The row that is being checked.
         * @param column
         * The column that is being checked.
         * @return
         * Returns true if position is occupied.
         */
        
        bool isOccupied(int row, int columm);
        /**
         * @brief
        ...
        bool isPathObstructed(int fromRow, int fromCol, int toRow, int toCol);
        /**
         * @brief
         * Checks if the piece's path is not obstructed from start to finish.
         * @param fromRow
         * The row of the piece to be moved.
         * @param fromCol
         * The column of the piece to be moved.
         ...
         * The column of the destination position.
         * @return
         * Returns true if path is obstructed.
         */
